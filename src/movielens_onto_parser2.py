...
#           CANADA
# -------------------------------
# Canada subsumes itself, all US zipcodes, and all movies 
# rated by users in the canada
key_canada = "canada"
value_canada = []
...
#              US
# -------------------------------
# US subsumes itself, all US zipcodes, and all movies 
# rated by users in the US
key_us = "us"
value_us = []
...
#            MOVIE
# -------------------------------
# movie subsumes itself and all movie titles
key_movie = "movie"
value_movie = []
...
#         ZIPCODES_CA
# -------------------------------
# zip codes subsume themselves and movies rated by users
# in the zip code
...
#          USERS_CA
# -------------------------------
# Users subsume themselves and the movies they rated
